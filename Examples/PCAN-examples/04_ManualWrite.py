...
class ManualWrite():
    ...
    def __init__(self):
        ...
        print("Press any key to write")
        self.getch()
        strinput = "y" if GETCH_SUPPORTED else "n"
        while strinput == "y":
            self.clear()
            self.WriteMessages()
            print("Do you want to write again? yes[y] or any other key to close")
            strinput = chr(ord(self.getch()))
    ...
    def getch(self):
        ...
        if GETCH_SUPPORTED:
            ...
            print("getch() is not supported... Defaulting input to '" + res + "'.")
        return res
